...
export interface AppForwarderInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "eip712Domain"
      | "execute"
...
export interface AppForwarder extends BaseContract {
  connect(runner?: ContractRunner | null): AppForwarder;
  waitForDeployment(): Promise<this>;

  interface: AppForwarderInterface;
